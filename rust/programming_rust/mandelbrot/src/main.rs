...
/// the character given by the `separator` argument, and the `<left> and <right>
...
fn pixel_to_point(
    ...
    Complex {
        ...
        im: upper_left.im - pixel.1 as f64 * height / bounds.1 as f64, // Why substraction here? pixel.1 increases as we go down,
