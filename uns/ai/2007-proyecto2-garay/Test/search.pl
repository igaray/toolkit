% search.pl: Predicates common to all searches
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% dfs_search/5
dfs_search(Frontier, _Visited, [Position|Path], Path_Cost, [Frontier_Positions]) :-
    dfs_select(node(Position, Path, Path_Cost), Frontier, _Frontier1),
    is_goal(Position),
    frontier_positions(Frontier, Frontier_Positions).

dfs_search(Frontier, Visited, Solution, Cost, [Frontier_Positions|Frontier_List]) :-
    ...
    dfs_search(New_Frontier, [node(Position, Path, Path_Cost)|Visited], Solution, Cost, Frontier_List).
