...
#define dynarr_type(type) dynarr_##type##_t

/* a must be of type dynarr_type(TYPE)
 * init_size must be of type size_t
 */
#define dynarr_init(type, a, init_size) dynarr_init_##type(&(a), (init_size))

/* a must be of type dynarr_type(type) */
#define dynarr_free(type, a) dynarr_free_##type(&(a))

/* a must be of type dynarr_type(type)
 * newsize must be of type size_t
 */
#define dynarr_resize(type, a, newsize) dynarr_resize_##type(&(a), (newsize))

/* a must be of type dynarr_type(type)
 * i must be of type size_t
 */
#define dynarr_get(type, a, i) dynarr_get_##type(&(a), (i))

/* a must be of type dynarr_type(type)
 * i must be of type size_t
 * v must be of type type
 */
#define dynarr_set(type, a, i, value) dynarr_set_##type(&(a), (i), (value))
