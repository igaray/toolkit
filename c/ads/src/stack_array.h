...
#define stckarr_type(type) stckarr_##type##_t

#define stckarr_init(type, s, init_size) stckarr_init_##type(&(s), (init_size))

#define stckarr_free(type, s) stckarr_free_##type(&(s))

#define stckarr_push(type, s, v) stckarr_push_##type(&(s), (v))

#define stckarr_pop(type, s) stckarr_pop_##type(&(s))

#define stckarr_empty(s) ((s)->top == 0)

#define stckarr_size(s) ((s)->top + 1)
